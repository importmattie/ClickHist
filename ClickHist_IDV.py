...
class ClickHist:
    def __init__(self,xBinEdges,yBinEdges,xData,yData,**kwargs):
        ...
        # version.
        self.xDataFracFlat,self.yDataFracFlat,\
        self.pointColors = self.generatePlotPositions()
        ...
        if(self.thinking == 0):
            ...
            if((self.xPixFracStart < xClickFrac < self.xPixFracEnd) and
                ...
                closestDataX = self.convertFracToValue(
                    self.xDataFracFlat[locOfMinError],self.xBinEdges,
                    self.xBinEdgesFrac)
                closestDataY = self.convertFracToValue(
                    self.yDataFracFlat[locOfMinError],self.yBinEdges,
                    self.yBinEdgesFrac)
                ...
                # for ClickHistDo and then call it.
                    ...
                    # Here is an implementation with specific IDV functionality
    ...
    def showPlot(self):
        ...
        # is as desired
        self.axes_2D.scatter(self.xDataFracFlat,self.yDataFracFlat,
    ...
    def generatePlotPositions(self):
        ...
        scatter point, xDataFracFlat and yDataFracFlat, using a fractional
        system with 0 and 1 as end points (e.g. 0.5 is "halfway") as well as
        ...
        return np.array(xDataFracFlat),np.array(yDataFracFlat),\
               np.array(pointColors)
    ...
    def findNearestPointToClick(self,xClickVal,yClickVal):
        ...
        """
        error = ((self.xDataFracFlat-xClickVal)**2+
                 (self.yDataFracFlat-yClickVal)**2)**0.5
